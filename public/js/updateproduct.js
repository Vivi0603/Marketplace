...
jQuery(function($){
    ...
    if (myForm) {
      myForm.submit(function (event) {
        ...
        else if(productName && !/[a-zA-Z0-9]/.test(productName)) errorList.append(`<li> Product Name should only contain numbers and alphabets</li>`);
